...
def CSServices():
  ...
  graph = Graph.from_dot("CSServices", "graphviz/stage1/CSServices.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def CSCounselling():
  ...
  graph = Graph.from_dot("CSCounselling", "graphviz/stage1/CSCounselling.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def CSCounsellingManagement():
  ...
  graph = Graph.from_dot("CSCounsellingManagement", "graphviz/stage1/CSCounsellingManagement.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def CSCounsellingManagementSD():
  ...
  resources = ["Counselling Resources", "Double Head Set", "Salary", "Counselling Workshops"
               ,"Counselling Policies", "Web Moderator Meetings", "Call Statistics",
               "Historical Data of Call Volumes"]
  graph = Graph.from_dot("CSCounsellingManagementSD", "graphviz/stage1/CSCounsellingManagementSD.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def CSCounsellingSD():
  ...
  resources = ["Information in E-Library", "Information Binders at Stations",
               ...
               "Counselling Policies", "Web Moderator Meetings", "Counsellor Experience",
               "Caller Statistics", "Web Site Content", "Feedback"]
  graph = Graph.from_dot("CSCounsellingSD", "graphviz/stage1/CSCounsellingSD.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def CSFDandMarketing():
  ...
  graph = Graph.from_dot("CSFDandMarketing", "graphviz/stage1/CSFD and Marketing.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def CSFDandMarketingSD():
  ...
  graph = Graph.from_dot("CSFDandMarketingSD", "graphviz/stage1/CSFD and MarketingSD.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def CSITDepartment():
  ...
  graph = Graph.from_dot("CSITDepartment", "graphviz/stage1/CSITDepartment.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def CSSAProgram():
  ...
  graph = Graph.from_dot("CSSAProgram", "graphviz/stage1/CSSAProgram.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def CSSimplified():
  ...
  graph = Graph.from_dot("CSSimplified", "graphviz/stage1/CSSimplified.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def KidsAndYouth():
  ...
  resources = ["Feedback"]
  graph = Graph.from_dot("Kids and Youth", "graphviz/stage1/Kids and Youth.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def Parents():
  ...
  graph = Graph.from_dot("Parents", "graphviz/stage1/Parents.gv", resources, containers)
  Graph.json(graph, "json/stage1/%s.json"%graph.name)
  return graph
...
def OOOChatRooms():
  ...
  graph = Graph.from_dot("OOOChatRooms", "graphviz/stage2/chat_room.gv", resources, containers)
  Graph.json(graph, "json/stage2/%s.json"%graph.name)
  return graph
...
def DelayModeratedBulletinBoard():
  ...
  resources = []
  graph = Graph.from_dot("DelayModeratedBulletinBoard", "graphviz/stage2/Delay Moderated Bulletin Board.gv", resources, containers)
  Graph.json(graph, "json/stage2/%s.json"%graph.name)
  return graph
